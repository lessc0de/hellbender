...
public class SmallBamWriter implements Serializable {
     ...
     */
    public static void writeToFile(Pipeline pipeline, PCollection<MutableGATKRead> reads, final SAMFileHeader header, final String destPath) {
        PCollectionView<Iterable<MutableGATKRead>> iterableView =
                reads.apply(View.<MutableGATKRead>asIterable());
    ...
    private static class SaveToBAMFile extends DoFn<String,Void> implements Serializable {
        ...
        private final PCollectionView<Iterable<MutableGATKRead>> iterableView;

        public SaveToBAMFile(SAMFileHeader header, PCollectionView<Iterable<MutableGATKRead>> iterableView) {
            this.header = header;
        ...
        public void processElement(ProcessContext c) throws Exception {
            ...
            Iterable<MutableGATKRead> reads = c.sideInput(iterableView);
