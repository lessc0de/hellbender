 ...
 */
public final class ReadsDataSource implements GATKDataSource<MutableGATKRead>, AutoCloseable {
    ...
    public Iterator<MutableGATKRead> iterator() {
        ...
        final Iterator<MutableGATKRead> traversalIter = prepareIteratorsForTraversal(preparedIntervals);
     ...
     */
    @Override
    public Iterator<MutableGATKRead> query( final SimpleInterval interval ) {
        if ( ! indicesAvailable )
     ...
     */
    private Iterator<MutableGATKRead> prepareIteratorsForTraversal( final QueryInterval[] queryIntervals ) {
