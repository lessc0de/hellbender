...
/**
 * An abstract class representing a {@link PTransform<MutableGATKRead, Output>}.
 ...
 */
public abstract class PTransformSAM<Output> extends PTransform<PCollection<MutableGATKRead>,PCollection<Output>> {
     ...
     *                     Must be non-null and must be a valid header for the the PCollection<MutableGATKRead> that this transform is processing.
     */
