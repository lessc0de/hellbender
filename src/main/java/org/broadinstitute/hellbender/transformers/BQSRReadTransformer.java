...
public final class BQSRReadTransformer implements ReadTransformer {
     ...
     */
    public BQSRReadTransformer(final SAMFileHeader header, final File bqsrRecalFile, final int quantizationLevels, final boolean disableIndelQuals, final int preserveQLessThan, final boolean emitOriginalQuals, final double globalQScorePrior) {
