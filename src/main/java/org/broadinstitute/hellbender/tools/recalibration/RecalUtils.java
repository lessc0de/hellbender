...
public final class RecalUtils {
     ...
     * @param RAC  The list of shared command line arguments
     */
    public static void parsePlatformForRead(final MutableGATKRead read, final SAMFileHeader header, final RecalibrationArgumentCollection RAC) {
     ...
     */
    private static byte getNextBaseFromColor(MutableGATKRead read, final byte prevBase, final byte color) {
        switch (color) {
            case '0':
                return prevBase;
            case '1':
     ...
     */
    public static boolean isColorSpaceConsistent(final SOLID_NOCALL_STRATEGY strategy, final MutableGATKRead read, final SAMFileHeader header) {
     ...
     */
    public static boolean isColorSpaceConsistent(final MutableGATKRead read, final int offset) {
        if (read.hasAttribute(RecalUtils.COLOR_SPACE_INCONSISTENCY_TAG)) {
     ...
     */
    public static ReadCovariates computeCovariates(final MutableGATKRead read, final SAMFileHeader header, final StandardCovariateList covariates) {
     ...
     */
    public static void computeCovariates(final MutableGATKRead read, final SAMFileHeader header, final StandardCovariateList covariates, final ReadCovariates resultsStorage) {
