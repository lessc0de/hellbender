...
public final class BaseRecalibrator extends ReadWalker {
     ...
     */
    @Override
    public void apply( MutableGATKRead originalRead, ReferenceContext ref, FeatureContext featureContext ) {
    ...
    private boolean[] calculateSkipArray( final MutableGATKRead read, final FeatureContext featureContext ) {
    ...
    protected boolean[] calculateKnownSites( final MutableGATKRead read, final List<? extends Feature> features) {
    ...
    protected static int[] calculateIsSNP( final MutableGATKRead read, final ReferenceContext ref, final MutableGATKRead originalRead ) {
