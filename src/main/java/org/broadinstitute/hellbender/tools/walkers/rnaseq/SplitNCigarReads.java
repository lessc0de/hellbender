...
public final class SplitNCigarReads extends CommandLineProgram {
    ...
    protected Object doWork() {
        ...
        final Iterable<MutableGATKRead> readIter = new SAMRecordToReadIterator(in.iterator());
     ...
     */
    public static MutableGATKRead splitNCigarRead(final MutableGATKRead read, OverhangFixingManager manager) {
     ...
     */
    private static MutableGATKRead splitReadBasedOnCigar(final MutableGATKRead read, final int cigarStartIndex, final int cigarEndIndex, final OverhangFixingManager forSplitPositions) {
