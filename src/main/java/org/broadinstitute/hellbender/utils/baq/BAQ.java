...
public final class BAQ {
     ...
     * @return
     */
    public static byte[] getBAQTag(MutableGATKRead read) {
        String s = read.getAttributeAsString(BAQ_TAG);
        return s != null ? s.getBytes() : null;
    }

    public static String encodeBQTag(MutableGATKRead read, byte[] baq) {
    ...
    public static void addBAQTag(MutableGATKRead read, byte[] baq) {
    ...
    /**
      ...
      * @return
      */
    public static boolean hasBAQTag(MutableGATKRead read) {
     ...
     * @return
     */
    public static byte[] calcBAQFromTag(MutableGATKRead read, boolean overwriteOriginalQuals, boolean useRawQualsIfNoBAQTag) {
     ...
     * @return
     */
    public static byte calcBAQFromTag(MutableGATKRead read, int offset, boolean useRawQualsIfNoBAQTag) {
    ...
    public static class BAQCalculationResult {
        ...
        public BAQCalculationResult(MutableGATKRead read, byte[] ref) {
     ...
     public BAQCalculationResult calcBAQFromHMM(MutableGATKRead read, ReferenceDataSource refDS) {
...
//            logger.info("n = " + n + ": Total " + total.getElapsedTimeNano() + " local " + local.getElapsedTimeNano());
     ...
     * @return
     */
    private final Pair<Integer,Integer> calculateQueryRange(MutableGATKRead read) {
    ...
    public BAQCalculationResult calcBAQFromHMM(MutableGATKRead read, byte[] ref, int refOffset) {
     ...
     */
    public byte[] baqRead(MutableGATKRead read, ReferenceDataSource refDS, CalculationMode calculationType, QualityMode qmode ) {
     ...
     * @return
     */
    public boolean excludeReadFromBAQ(MutableGATKRead read) {
