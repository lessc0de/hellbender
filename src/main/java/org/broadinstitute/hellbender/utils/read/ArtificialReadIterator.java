...
public class ArtificialReadIterator implements Iterator<MutableGATKRead>, Iterable<MutableGATKRead> {
    ...
    // the next record
    protected MutableGATKRead next = null;
