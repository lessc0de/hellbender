...
public final class ReadClipperTestUtils {
     ...
     */
    public static MutableGATKRead makeReadFromCigar(String cigarString) {
     ...
     * @return artificial read
     */
    public static MutableGATKRead makeReadFromCigar(Cigar cigar) {
        return makeReadFromCigar(cigar, 0);
    }

    private static MutableGATKRead makeReadFromCigar(Cigar cigar, int lengthChange) {
        int readLength = cigar.getReadLength();
        if (readLength >= -lengthChange) {
            readLength += lengthChange;
        }
        return ArtificialReadUtils.createArtificialRead(Utils.arrayFromArrayWithLength(BASES, readLength), Utils.arrayFromArrayWithLength(QUALS, readLength), cigar.toString());
    }
     ...
     * @return artificial read
     */
    public static MutableGATKRead makeReadFromCigar(String cigarString, int lengthChange) {
