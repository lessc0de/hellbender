...
public final class ClippingOp {
     ...
     */
    public MutableGATKRead apply(ClippingRepresentation algorithm, MutableGATKRead originalRead) {
        MutableGATKRead read = originalRead.copy();
    ...
    private MutableGATKRead revertSoftClippedBases(MutableGATKRead read) {
        MutableGATKRead unclipped = read.copy();
     ...
     */
    private MutableGATKRead hardClip(MutableGATKRead read, int start, int stop) {
        ...
        final MutableGATKRead hardClippedRead = read.copy();
