...
public final class ReadTransformerTest {
    ...
    public void testAndThen( final MutableGATKRead read ) {
    ...
    @Test(dataProvider = "UnmodifiedReadDataProvider")
    public void testCompose( final MutableGATKRead read ) {
    ...
    @Test(dataProvider = "UnmodifiedReadDataProvider")
    public void testAndChain( final MutableGATKRead read ) {
    ...
    @Test(dataProvider = "UnmodifiedReadDataProvider")
    public void testMixedChain( final MutableGATKRead read ) {
    ...
    @Test(dataProvider = "UnmodifiedReadDataProvider")
    public void testIdentity( final MutableGATKRead read ) {
