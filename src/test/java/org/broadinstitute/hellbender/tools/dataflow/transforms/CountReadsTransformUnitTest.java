...
public final class CountReadsTransformUnitTest extends BaseTest{
    ...
    public void testCountReadsTransform(long numberOfReads){
        List<MutableGATKRead> reads = Collections.nCopies((int)numberOfReads, new GoogleGenomicsReadToGATKReadAdapter(new Read()) );

        Pipeline p = GATKTestPipeline.create();
        DataflowUtils.registerGATKCoders(p);
        PTransform<PCollection<MutableGATKRead>, PCollection<Long>> countReads = new CountReadsDataflowTransform();
