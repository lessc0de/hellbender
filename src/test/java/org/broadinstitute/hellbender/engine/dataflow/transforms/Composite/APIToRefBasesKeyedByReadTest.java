...
public final class APIToRefBasesKeyedByReadTest {
    ...
    public void refBasesTest(List<MutableGATKRead> reads, List<KV<MutableGATKRead, ReferenceBases>> kvReadRefBases,
        ...
        PCollection<KV<MutableGATKRead, ReferenceBases>> result = APIToRefBasesKeyedByRead.addBases(pReads, mockSource, refAPIMetadata);
